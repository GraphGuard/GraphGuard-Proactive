...
for epoch in range(10):
    ...
    # forward propagation by using all nodes
    # print(shadow_graph_features.size())
    logits = model(g_new, shadow_graph_features)
...
# unlearned_g = dgl.node_subgraph(dgl_target_graph, label_others_index_target_graph_mask)
# exact_unlearned_model = SAGE(in_feats=target_graph_n_features, hid_feats=100, out_feats=target_graph_n_labels)
# exact_unlearned_opt = th.optim.Adam(exact_unlearned_model.parameters())
#
# print("start training target model")
# for epoch in range(100):
#     exact_unlearned_model.train()
#     # forward propagation by using all nodes
#     # print(target_graph_features.size())
#     logits = exact_unlearned_model(dgl_target_graph, target_graph_features)
#     # compute loss
#     # print(logits.size())
#     # print(target_graph_train_mask)
#     # print(target_graph_labels.size())
#     exact_unlearned_loss = F.cross_entropy(logits[target_graph_train_mask], target_graph_labels[target_graph_train_mask])
#     # # compute validation accuracy
#     # acc = evaluate(model, dgl_target_graph, target_graph_features, target_graph_labels, target_graph_test_mask)
#     # backward propagation
#     exact_unlearned_opt.zero_grad()
#     exact_unlearned_loss.backward()
#     exact_unlearned_opt.step()
#     # print(loss.item())
#
# acc = evaluate(exact_unlearned_model, dgl_target_graph, target_graph_features, target_graph_labels, target_graph_test_mask)
# print("exact unlearned model accuracy is")
# print(acc)
